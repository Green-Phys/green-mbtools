...
# CQMP/Maxent executable
maxent_exe = 'path_to_cqmp_maxent_compile_dir'
...
MB.AC_maxent(
    error=5e-3, maxent_exe=maxent_exe,
    params='../tests/test_data/Maxent/green.param', outdir='Maxent'
)
...
MB.AC_maxent(
    error=5e-3, maxent_exe=maxent_exe,
    params='../tests/test_data/Maxent/green.param',
    outdir='Maxent_orbsum', gtau_orth=Gt_orbsum
)
