...
# Only work for full_bz object
def interpolate_G(Fk, Sigma_tk, mu, Sk, kmesh, kpts_inter, ir, dim=3, hermi=False, debug=False):
  ...
  if Sigma_tk is not None:
    ...
    Sigma_tk_int = interpolate_tk_object(Sigma_tk, kmesh, kpts_inter, dim, hermi, debug)
  else:
    Sigma_tk_int = None
